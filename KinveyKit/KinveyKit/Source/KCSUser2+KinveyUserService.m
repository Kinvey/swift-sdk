...
{
    DISPATCH_USER2_BLOCK(completionBlock);
                           ...
                           completionHandler:^(NSURLResponse *response, NSData *data, NSError *error)
     {
         if (error) {
             ...
             if (httpResponse.statusCode == 200 && data) {
                 ...
                 if (completionBlock) {
                     NSError* error = [NSError errorWithDomain:[NSHTTPURLResponse localizedStringForStatusCode:httpResponse.statusCode]
             ...
             NSError *error = [NSError errorWithDomain:@"Bad Request"
                                                  code:400
                                              userInfo:@{}];
             completionBlock(nil, error);
         }
...
{
    DISPATCH_USER_SEND_EMAIL_BLOCK(completionBlock);
...
{
    DISPATCH_USER_CHECK_USERNAME_BLOCK(completionBlock);
