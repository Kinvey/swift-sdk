...
+(KCSRequest*)requestUserWithUsername:(NSString *)username password:(NSString *)password withCompletionBlock:(KCSUserCompletionBlock)completionBlock KCS_DEPRECATED(Use +[KCSUser userWithUsername:password:fieldsAndValues:withCompletionBlock:] instead, 1.25.0);
...
+(KCSRequest*)requestUserWithUsername:(NSString *)username password:(NSString *)password fieldsAndValues:(NSDictionary*)fieldsAndValues withCompletionBlock:(KCSUserCompletionBlock)completionBlock;
...
+ (KCSRequest*)requestCreateAutogeneratedUser:(KCSUserCompletionBlock)completionBlock KCS_DEPRECATED(Use +[KCSUser createAutogeneratedUser:completion:] instead, 1.25.0);
...
+(KCSRequest*)requestCreateAutogeneratedUser:(NSDictionary*)fieldsAndValues
...
+(KCSRequest*)requestLoginWithUsername:(NSString*)username
                              password:(NSString*)password
                   withCompletionBlock:(KCSUserCompletionBlock)completionBlock;
...
+(KCSRequest*)requestLoginWithSocialIdentity:(KCSUserSocialIdentifyProvider)provider
...
+(KCSRequest*)requestLoginWithAuthorizationCodeAPI:(NSString*)redirectURI
                                           options:(NSDictionary*)options
                               withCompletionBlock:(KCSUserCompletionBlock)completionBlock;
...
+(KCSRequest*)requestSendPasswordResetForUser:(NSString*)usernameOrEmail withCompletionBlock:(KCSUserSendEmailBlock)completionBlock;
...
+(KCSRequest*)requestSendForgotUsername:(NSString*)email withCompletionBlock:(KCSUserSendEmailBlock)completionBlock;
...
+(KCSRequest*)requestSendEmailConfirmationForUser:(NSString*)username withCompletionBlock:(KCSUserSendEmailBlock)completionBlock;
...
+(KCSRequest*)requestCheckUsername:(NSString*)potentialUsername withCompletionBlock:(KCSUserCheckUsernameBlock)completionBlock;
