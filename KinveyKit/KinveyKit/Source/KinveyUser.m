...
+ (void) createAutogeneratedUser:(NSDictionary *)fieldsAndValues completion:(KCSUserCompletionBlock)completionBlock
{
    ...
    [self requestCreateAutogeneratedUser:fieldsAndValues
...
{
    SWITCH_TO_MAIN_THREAD_USER_BLOCK(completionBlock);
    return [KCSUser2 requestCreateAutogeneratedUser:fieldsAndValues completion:^(id<KCSUser2> user, NSError *error) {
...
{
    SWITCH_TO_MAIN_THREAD_USER_BLOCK(completionBlock);
    [self requestCreateAutogeneratedUser:completionBlock];
}

+(KCSRequest *)requestCreateAutogeneratedUser:(KCSUserCompletionBlock)completionBlock
{
    SWITCH_TO_MAIN_THREAD_USER_BLOCK(completionBlock);
    return [self requestCreateAutogeneratedUser:nil completion:completionBlock];
}
...
{
    SWITCH_TO_MAIN_THREAD_USER_BLOCK(completionBlock);
    [self requestUserWithUsername:username
                         password:password
...
{
    SWITCH_TO_MAIN_THREAD_USER_BLOCK(completionBlock);
    return [KCSUser2 requestCreateUserWithUsername:username password:password fieldsAndValues:fieldsAndValues completion:^(id<KCSUser2> user, NSError *error) {
        completionBlock(user, error, KCSUserNoInformation);
    }];
}
...
+(KCSRequest *)requestUserWithUsername:(NSString *)username
                              password:(NSString *)password
                   withCompletionBlock:(KCSUserCompletionBlock)completionBlock
{
    SWITCH_TO_MAIN_THREAD_USER_BLOCK(completionBlock);
    return [self requestUserWithUsername:username password:password fieldsAndValues:nil withCompletionBlock:completionBlock];
}
...
{
    SWITCH_TO_MAIN_THREAD_USER_BLOCK(completionBlock);
    return [KCSUser2 requestLoginWithUsername:username password:password completion:^(id<KCSUser2> user, NSError *error) {
        completionBlock(user, error, KCSUserNoInformation);
    }];
}
...
{
    [self requestLoginWithSocialIdentity:provider
...
{
    SWITCH_TO_MAIN_THREAD_USER_BLOCK(completionBlock);
    return [KCSUser2 requestConnectWithAuthProvider:provider accessDictionary:accessDictionary completion:^(id<KCSUser2> user, NSError *error) {
        completionBlock(user, error, KCSUserNoInformation);
    }];
}
...
+(void)loginWithAuthorizationCodeAPI:(NSString *)redirectURI
                 ...
                 withCompletionBlock:(KCSUserCompletionBlock)completionBlock
{
    [self requestLoginWithAuthorizationCodeAPI:redirectURI
                                       options:options
                           withCompletionBlock:completionBlock];
}
...
{
    SWITCH_TO_MAIN_THREAD_USER_BLOCK(completionBlock);
    return [KCSUser2 requestLoginWithAuthorizationCodeAPI:redirectURI
                                                  options:options
...
{
    [self requestSendPasswordResetForUser:usernameOrEmail
                      withCompletionBlock:completionBlock];
}
...
+(KCSRequest *)requestSendPasswordResetForUser:(NSString *)usernameOrEmail withCompletionBlock:(KCSUserSendEmailBlock)completionBlock
{
    ...
    return [KCSUser2 requestSendPasswordResetForUsername:usernameOrEmail completion:completionBlock];
}

+ (void) sendEmailConfirmationForUser:(NSString*)username withCompletionBlock:(KCSUserSendEmailBlock)completionBlock
{
    [self requestSendEmailConfirmationForUser:username
                          withCompletionBlock:completionBlock];
}
...
{
    SWITCH_TO_MAIN_THREAD_USER_SEND_EMAIL_BLOCK(completionBlock);
    return [KCSUser2 requestSendEmailConfirmationForUser:username completion:completionBlock];
}

+ (void) sendForgotUsername:(NSString*)email withCompletionBlock:(KCSUserSendEmailBlock)completionBlock
{
    [self requestSendForgotUsername:email
                withCompletionBlock:completionBlock];
}
...
{
    SWITCH_TO_MAIN_THREAD_USER_SEND_EMAIL_BLOCK(completionBlock);
    return [KCSUser2 requestSendForgotUsernameEmail:email completion:completionBlock];
}

+(void) checkUsername:(NSString*)potentialUsername withCompletionBlock:(KCSUserCheckUsernameBlock)completionBlock
{
    [self requestCheckUsername:potentialUsername
           withCompletionBlock:completionBlock];
}
...
+(KCSRequest *)requestCheckUsername:(NSString *)potentialUsername withCompletionBlock:(KCSUserCheckUsernameBlock)completionBlock
{
    ...
    return [KCSUser2 requestCheckUsername:potentialUsername completion:completionBlock];
}
