...
// observer block
typedef void(^KCS_DTReachabilityObserverBlock)(SCNetworkConnectionFlags connectionFlags);
 ...
 */
@interface KCS_DTReachability : NSObject
 ...
 */
+ (id)addReachabilityObserverWithBlock:(KCS_DTReachabilityObserverBlock)observer;
