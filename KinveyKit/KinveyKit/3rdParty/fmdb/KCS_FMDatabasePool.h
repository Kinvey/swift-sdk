...
@interface KCS_FMDatabasePool : NSObject {
    NSString            *_path;
...
@interface NSObject (KCS_FMDatabasePoolDelegate)

- (BOOL)databasePool:(KCS_FMDatabasePool*)pool shouldAddDatabaseToPool:(KCS_FMDatabase*)database;
