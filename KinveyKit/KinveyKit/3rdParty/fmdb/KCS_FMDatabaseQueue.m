...
+ (instancetype)databaseQueueWithPath:(NSString*)aPath flags:(int)openFlags {
    ...
    KCS_FMDatabaseQueue *q = [[self alloc] initWithPath:aPath flags:openFlags];
...
- (void)inDatabase:(void (^)(KCS_FMDatabase *db))block {
    ...
    KCS_FMDatabaseQueue *currentSyncQueue = (__bridge id)dispatch_get_specific(kDispatchQueueSpecificKey);
