...
- (void) testAutoBasic
{
    __weak XCTestExpectation* expectationGenerateUser = [self expectationWithDescription:@"generateUser"];
...
{
    __weak XCTestExpectation* expectationCreateUser = [self expectationWithDescription:@"createUser"];
    __block id createdUser = nil;
    NSString* uname = [NSString UUID];
    NSString* password = [NSString UUID];
