...
- (void) testAutoBasic
{
    XCTestExpectation* expectationGenerateUser = [self expectationWithDescription:@"generateUser"];
...
{
    XCTestExpectation* expectationCreateUser = [self expectationWithDescription:@"createUser"];
    __block id createdUser = nil;
    NSString* uname = [NSString UUID];
    NSString* password = [NSString UUID];
