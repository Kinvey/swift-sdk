...
- (void) testPasswordReset
{
    ...
    XCTestExpectation* expectationResetPassword = [self expectationWithDescription:@"resetPassword"];
...
- (void) testChangePassword
{
    ...
    XCTestExpectation* expectationChangePassword = [self expectationWithDescription:@"changePassword"];
...
- (void) testForgotUsername
{
    ...
    XCTestExpectation* expectationSendForgotUsername = [self expectationWithDescription:@"sendForgotUsername"];
