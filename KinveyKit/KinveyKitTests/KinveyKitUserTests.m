...
- (void) testCustomAttributeIsPersisted
{
    ...
    STAssertNotNil(newUser, @"a user");
    STAssertEquals(newUser, _user, @"should get back user");
    
    STAssertEqualObjects([newUser getValueForAttribute:@"custom"], val, @"should get the val back");
}
