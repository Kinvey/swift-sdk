...
+ (BOOL) setUpKinveyUnittestBackend:(XCTestCase*)testCase
{
    ...
    XCTestExpectation* expectationCreateAutogeneratedUser = [testCase expectationWithDescription:@"createAutogeneratedUser"];
    ...
    XCTestExpectation* expectationPingKinvey = [testCase expectationWithDescription:@"pingKinvey"];
