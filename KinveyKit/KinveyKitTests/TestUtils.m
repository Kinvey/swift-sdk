...
+ (BOOL) setUpKinveyUnittestBackend:(XCTestCase*)testCase
{
    ...
    __weak XCTestExpectation* expectationCreateAutogeneratedUser = [testCase expectationWithDescription:@"createAutogeneratedUser"];
    ...
    [testCase waitForExpectationsWithTimeout:30 handler:nil];
    
    __weak XCTestExpectation* expectationPingKinvey = [testCase expectationWithDescription:@"pingKinvey"];
