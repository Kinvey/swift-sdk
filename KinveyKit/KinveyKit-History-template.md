...
* Updates to User API
    * __TODO__ add fields and values at creation time - eg email - JUST ONE CALL
    ...
    * __TODO__ user credential storage - simplified & no more passwords
    ...
    * __TODO__ no more automatic refresh - must do when the user should be loaded
* Code Cleanup:
