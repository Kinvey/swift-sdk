...
- (__KNVClient * _Nonnull)initializeWithAppKey:(NSString * _Nonnull)appKey appSecret:(NSString * _Nonnull)appSecret apiHostName:(NSURL * _Nonnull)apiHostName authHostName:(NSURL * _Nonnull)authHostName encrypted:(BOOL)encrypted schemaVersion:(unsigned long long)schemaVersion migrationHandler:(void (^ _Nullable)(KNVMigration * _Nonnull migration, unsigned long long schemaVersion))migrationHandler;

/// Initialize a Client instance with all the needed parameters.
- (__KNVClient * _Nonnull)initializeWithAppKey:(NSString * _Nonnull)appKey appSecret:(NSString * _Nonnull)appSecret apiHostName:(NSURL * _Nonnull)apiHostName authHostName:(NSURL * _Nonnull)authHostName encryptionKey:(NSData * _Nullable)encryptionKey schemaVersion:(unsigned long long)schemaVersion migrationHandler:(void (^ _Nullable)(KNVMigration * _Nonnull migration, unsigned long long schemaVersion))migrationHandler;
...
- (void)execute:(Class _Nonnull)persistableClass migrationObjectHandler:(NSDictionary<NSString *, id> * _Nullable (^ _Nullable)(NSDictionary<NSString *, id> * _Nonnull oldEntity))migrationObjectHandler;
@end
