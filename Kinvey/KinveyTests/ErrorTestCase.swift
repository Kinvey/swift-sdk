...
class ErrorTestCase: KinveyTestCase {
    ...
    func testInvalidResponse() {
        XCTAssertEqual(Error.InvalidResponse(httpResponse: nil, data: nil).localizedDescription, "Invalid response from the server")
    }
    
    func testUnauthorized() {
        XCTAssertEqual(Error.Unauthorized(httpResponse: nil, data: nil, error: "Error", description: "Description").localizedDescription, "Description")
    }
