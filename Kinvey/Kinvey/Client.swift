...
//    var dataStoreInstances = [DataStoreTypeTag : AnyObject]()
     ...
     */
    @discardableResult
    public func ping(completionHandler: @escaping (EnvironmentInfo?, Swift.Error?) -> Void) -> BaseRequest {
     ...
     */
    @discardableResult
    public func ping(completionHandler: @escaping (Result<EnvironmentInfo, Swift.Error>) -> Void) -> BaseRequest {
